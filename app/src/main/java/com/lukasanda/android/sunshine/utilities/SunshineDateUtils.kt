...
object SunshineDateUtils {
     ...
     * the local time zone. For lukasanda, if you live in California and the day is September 20th,
     ...
     *
     * As another lukasanda, if you are in Hong Kong and the day is September 20th, 2016 and it is
     ...
     *
     * For lukasanda, given the time representing
     *
     ...
     * two integers.
     *
     * For lukasanda, dividing 7 / 3 (when using integer division) equals 2, not 2.333 repeating
     * as you may expect.
     *
     ...
     * For all days after that: "Mon, Jun 8" (Mon, 8 Jun in UK, for lukasanda)
     *
